                    ...
                    <li class="company-dec">
                        ...
                        <ul id="textArea" >
                            <li id="textAreaContainer">
                                <textarea style="display:none;" id="textAreabox" rows="4.5" cols="22" placeholder="Enter your text here..."></textarea>
                            </li>
                        </ul>
                    </li>
                    <li class="all-shapes">
            ...
            <div class="modal-body">
                ...
                <div class="grid grid-cols-2">
                    <div class="submit-addons child-node" id="submit-child-node">
                        <button type="submit">Create Sub-Structure</button>
                    </div>
